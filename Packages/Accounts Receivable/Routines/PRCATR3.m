PRCATR3 ; GENERATED FROM 'PRCA TRANS PROFILE' PRINT TEMPLATE (#898) ; 02/10/10 ; (FILE 433, MARGIN=80)
 G BEGIN
N W !
...
BEGIN ;
 ...
 D N:$X>49 Q:'DN  W ?49 S Y=$P(X,U,2) S Y=$S(Y="":Y,$D(^PRCA(430,Y,0))#2:$P(^(0),U),1:Y) W $E(Y,1,30)
