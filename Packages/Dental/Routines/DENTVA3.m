DENTVA3 ;DSS/KC - DRM SITTING AND VISITS REPORT;10/20/2003 11:26
 ;;1.2;DENTAL;**43,45,47**;Aug 10, 2001
...
UNF(RET) ; Unfiled Data Report - called by DENTVAU
 ...
 N PROV,I,P,CNT,IP,PCODE,IDT,IEN,NAM,SSN,VIEN,DFN,NODE,PNAM,DPAT,PTCT
 I $G(DATA("PROV"))'="ALL" S PROV=$G(DATA("PROV")),I=1 F  Q:'$P(PROV,U,I)  D
 ...
 ...S @RET@(PNAM,NAM,IEN)=PNAM_U_$E(NAM,1,18)_" ("_$E(NAM)_SSN_")"_U_$$FMTE^XLFDT($P(N0,U,4)\1)
 ..Q
