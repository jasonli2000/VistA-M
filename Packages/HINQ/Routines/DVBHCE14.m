...
C2F1 N X,X1,X2 S DIXR=253 D C2X1(U) K X2 M X2=X D C2X1("O") K X1 M X1=X
 D
...
C3S S X="" G:DG(DQ)=X C3F1 K DB
 D ^DVBHCE15
C3F1 N X,X1,X2 S DIXR=254 D C3X1(U) K X2 M X2=X D C3X1("O") K X1 M X1=X
 D
...
C4S S X="" G:DG(DQ)=X C4F1 K DB
 D ^DVBHCE17
C4F1 N X,X1,X2 S DIXR=255 D C4X1(U) K X2 M X2=X D C4X1("O") K X1 M X1=X
 D
