LRMIPSZ4 ;SLC/CJS/BA - MICRO PATIENT REPORT - AFB, FUNGUS ; 6/22/87  16:17 ; [ 05/10/95  3:11 PM ]
...
SEN S LRTB=2 F I=0:0 S LRTB=+$O(^LR(LRDFN,"MI",LRIDT,12,LRTA,LRTB)) Q:LRTB'["2."!(LRTB="")  S LRTBA=$O(^DD(63.39,"GL",LRTB,1,0)),LRTBA=$P(^DD(63.39,LRTBA,0),U),LRTBS=^LR(LRDFN,"MI",LRIDT,12,LRTA,LRTB) W:$L(LRTBS) !,?3,LRTBA,?20,LRTBS
 K LRTB,LRTBA,LRTBS
 Q
FUNG ;from LRMIPSZ1
