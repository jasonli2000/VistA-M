YS29ENV ;DALIRMFO/MJD - YS*5.01*29 PATCH ENVIRONMENT CHECK ROUTINE ;07/18/97  5:22PM
 ;;5.01;MENTAL HEALTH;**29**;Dec 30, 1994
...
CHECK ;
 ...
 QUIT
 ;
EOR ;;YS*5.01*29 PATCH ENVIRONMENT CHECK ROUTINE;;
