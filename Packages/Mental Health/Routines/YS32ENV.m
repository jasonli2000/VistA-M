YS32ENV ;DALIRMFO/MJD - YS*5.01*32 PATCH ENVIRONMENT CHECK ROUTINE ;07/18/97  5:22 PM
 ;;5.01;MENTAL HEALTH;**32**;Dec 30, 1994
...
CHECK ;
 ...
 QUIT
 ;
EOR ;;YS*5.01*32 PATCH ENVIRONMENT CHECK ROUTINE;;
