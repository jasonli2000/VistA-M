YS38ENV ;DALIRMFO/MJD - YS*5.01*38 PATCH ENVIRONMENT CHECK ROUTINE ;07/18/97  5:22 PM
...
TAG ;
 ...
 ;
 S YSPATCH=""
 F YSPATCH="YS*5.01*24","YS*5.01*30","YS*5.01*32","YS*5.01*37" Q:$G(XPDQUIT)=2  D LOOK
 Q
 ;
LOOK ;
 ...
 QUIT
 ;
EOR ;;YS*5.01*38 PATCH ENVIRONMENT CHECK ROUTINE;;
