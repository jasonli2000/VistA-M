YS42ENV ;DALIRMFO/SPS - YS*5.01*42 PATCH ENVIRONMENT CHECK ROUTINE ;05/7/98
 ;;5.01;MENTAL HEALTH;**42**;Dec 30, 1994
...
TAG ;
 ...
 ;
 S YSPATCH=""
 F YSPATCH="YS*5.01*33","YS*5.01*37","YS*5.01*40" Q:$G(XPDQUIT)=2  D LOOK
 Q
 ;
LOOK ;
 ...
 QUIT
 ;
EOR ;;YS*5.01*42 PATCH ENVIRONMENT CHECK ROUTINE;;
