ORDEA01 ;ISP/RFR - DEA TOOLS;02/14/2013  09:09
...
PRVCHK ;CHECK SINGLE PROVIDER IS PROPERLY SETUP
 ...
 ..S TEXT=""
 .I STATUS=0 D
 ..I RETURN["Is permitted to prescribe" D WRAP^ORUTL("However, the provider is"_$P(RETURN,"Is",2),"LAST")
...
REPORTS ;PROMPT THE USER FOR THE REPORT TO RUN
 ...
 S REP("CFG")="Provider Incomplete Configuration;INCOMPL^ORDEA01A"
 S REP("DUP")="Duplicate VA Numbers;DUPVA^ORDEA01A"
 S REP("DET")="DETOX/MAINTENANCE ID List;DETOX^ORDEA01A"
 S REP("LAS")="Provider Last Names Containing Punctuation;LAST^ORDEA01A"
 S REP("FEE")="Fee Basis/C & A Providers Without a DEA Number;FEEDEA^ORDEA01A"
 S DIR(0)="SO"
