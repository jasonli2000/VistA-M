PSOPKIV1 ;BHAM ISC/MHA - validate PKI cert. ; 05/09/2002  8:15 am
 ;;7.0;OUTPATIENT PHARMACY;**131,146,223,148,249,391**;DEC 1997;Build 12
...
CER ;
 ...
 S PKI1=$S(PKI>89802014&(PKI<89802020)!((PKI>89802020)&(PKI<89802023)):2,1:1)
...
VERIFY(RET,PSIEN)       ;Verify PKI Data
 ...
 I RET="OK" S RET=1
 I RET["898020" S RET=$P(RET,"^",2)
 I RET["Cert Chain Error:" S RET=89802017
VQT ;
 K ^TMP("PSOPKIDATA",$J)
 Q
 ;
