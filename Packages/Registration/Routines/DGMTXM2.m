DGMTXM2 ; ;06/24/93
 D DE G BEGIN
DE S DIE="^DGMT(408.22,",DIC=DIE,DP=408.22,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$N(^DGMT(408.22,DA,-1))<0
...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="DGMTXM2",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;6",DV="SXR",DU="",DLB="DID YOU LIVE WITH YOUR SPOUSE LAST YEAR",DIFLD=.06
 S DE(DW)="C1^DGMTXM2"
 S DU="1:YES;0:NO;"
 G RE
