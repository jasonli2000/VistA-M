...
C1S S X="" Q:DG(DQ)=X  K DB S X=DG(DQ),DIC=DIE
 ...
 S X=DG(DQ),DIC=DIE
 X ^DD(2,.32101,1,3,1.3) I X S X=DIV S Y(1)=$S($D(^DPT(D0,.321)):^(.321),1:"") S X=$P(Y(1),U,2),X=X S DIU=X K Y S X=DIV S X="N" X ^DD(2,.32101,1,3,1.4)
 Q
