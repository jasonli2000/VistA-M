...
DE S DIE="^DPT(",DIC=DIE,DP=2,DL=2,DIEL=0,DU="" K DG,DE,DB Q:$N(^DPT(DA,-1))<0
 I $D(^(.321)) S %Z=^(.321) S %=$P(%Z,U,3) S:%]"" DE(1)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="DGPTX117",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW=".321;3",DV="RSX",DU="",DLB="RADIATION EXPOSURE INDICATED?",DIFLD=.32103
 S DE(DW)="C1^DGPTX117"
