...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="DGPTX48",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;9",DV="*P80.1'",DU="",DLB="OPERATION CODE 2",DIFLD=9
 S DE(DW)="C1^DGPTX48"
 S DU="ICD0("
 G RE
...
C1S S X="" Q:DG(DQ)=X  K DB S X=DG(DQ),DIC=DIE
 ...
 Q
X1 S DIC("S")="S DGI=9,DGCR=""AO"",DGSB=""S"" D EN1^DGPTFJC K DGI,DGCR,DGSB,K I 'DGER" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
2 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=2 D X2 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X2 I X K DGPTIT S DGNFLD="@40",Y="@800",DGPTIT(X_$C(59)_"ICD0(")=""
 Q
3 S DQ=4 ;@40
...
X5 I DGADD,$P(DGHOLD,U,10)]"" S Y="@50"
 Q
6 D:$D(DG)>9 F^DIE17 G ^DGPTX49
