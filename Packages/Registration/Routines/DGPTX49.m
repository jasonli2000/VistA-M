DGPTX49 ; ;06/24/93
 D DE G BEGIN
DE S DIE="^DGPT(D0,""S"",",DIC=DIE,DP=45.01,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$N(^DGPT(D0,"S",DA,-1))<0
...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="DGPTX49",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;10",DV="*P80.1'",DU="",DLB="OPERATION CODE 3",DIFLD=10
 S DE(DW)="C1^DGPTX49"
 S DU="ICD0("
 G RE
...
C1S S X="" Q:DG(DQ)=X  K DB S X=DG(DQ),DIC=DIE
 ...
 Q
X1 S DIC("S")="S DGI=10,DGCR=""AO"",DGSB=""S"" D EN1^DGPTFJC K DGI,DGCR,DGSB,K I 'DGER" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
2 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=2 D X2 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X2 I X K DGPTIT S DGNFLD="@50",Y="@800",DGPTIT(X_$C(59)_"ICD0(")=""
 Q
3 S DQ=4 ;@50
...
X5 I DGADD,$P(DGHOLD,U,11)]"" S Y="@60"
 Q
6 D:$D(DG)>9 F^DIE17 G ^DGPTX410
