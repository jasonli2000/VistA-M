...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$N(^DGPT(D0,"M",DA,-1))<0
 I $D(^(300)) S %Z=^(300) S %=$P(%Z,U,2) S:%]"" DE(1)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="DGPTX512",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="300;2",DV="SX",DU="",DLB="SUICIDE INDICATOR",DIFLD=300.02
...
X4 I '$D(DGBPC(3))!(DGDUP(3)) S Y="@820"
 Q
5 D:$D(DG)>9 F^DIE17 G ^DGPTX513
