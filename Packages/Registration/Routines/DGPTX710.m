...
DE S DIE="^DGPT(",DIC=DIE,DP=45,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$N(^DGPT(DA,-1))<0
 I $D(^(70)) S %Z=^(70) S %=$P(%Z,U,23) S:%]"" DE(1)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="DGPTX710",DQ=1
1 S DW="70;23",DV="*P80'",DU="",DLB="ICD 9",DIFLD=79.23
 S DU="ICD9("
 G RE
X1 S DIC("S")="S DGI=9 D EN3^DGPTFJC I 'DGER" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
