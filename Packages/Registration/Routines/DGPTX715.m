...
DE S DIE="^DGPT(",DIC=DIE,DP=45,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$N(^DGPT(DA,-1))<0
 I $D(^(300)) S %Z=^(300) S %=$P(%Z,U,4) S:%]"" DE(1)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="DGPTX715",DQ=1
1 S DW="300;4",DV="P45.61'X",DU="",DLB="SUBSTANCE ABUSE",DIFLD=300.04
 S DU="DIC(45.61,"
 S X=DGTX
 S Y=X
 G Y
X1 S DGFLAG=4 D 701^DGPTSC01 K:DGER X K DGFLAG,DGER
 Q
 ;
