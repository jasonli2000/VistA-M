DGPTXC ; GENERATED FROM 'DG PTF CREATE PTF ENTRY' INPUT TEMPLATE(#855), FILE 45;12/09/04
 D DE G BEGIN
...
C1F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=420,421,422,423,424,425,426,427,428,429,430,431,432,433,434 S DIEZRXR(45,DIXR)=""
 Q
X1 Q
...
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,D=0 K DE(1) ;50
 S DIFLD=50,DGO="^DGPTXC1",DC="39^45.02AI^M^",DV="45.02MNJ6,1X",DW="0;1",DOW="MOVEMENT RECORD",DLB="Select "_DOW S:D DC=DC_D
