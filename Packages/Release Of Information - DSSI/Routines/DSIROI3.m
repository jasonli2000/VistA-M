DSIROI3 ;dss/blj,AMC/EWL - Release Of Information ;05/21/2010 15:14
...
ISREQSTR(RET,DFN) ; DSIR IS PATIENT REQUESTOR
 ...
 ; INPUT  -  DFN - FULLY WUALIFIED POINTER TO ^DPT OR ^DSIR(19520.96
...
NXTRQSTR(N1,N5) ;
 ...
 I $G(STATE)]"" S TMP=^DIC(5,STATE,0),ST=$P(TMP,U,2)
