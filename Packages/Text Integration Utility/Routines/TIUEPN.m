TIUEPN ; GENERATED FROM 'TIU ENTER/EDIT PROGRESS NOTE' INPUT TEMPLATE(#1979), FILE 8925;02/20/98
 D DE G BEGIN
...
BEGIN S DNM="TIUEPN",DQ=1
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIEZ=1979,U="^"
