DIINIT	; ; 31-JAN-2013
	...
	S DIOVRD=1,U="^",DIFQ=0,DIFROM="22.2V1" W !,"This version (#22.2V1) of 'DIINIT' was created on 31-JAN-2013"
	W !?9,"(at V22P2.FILEMAN.MUMPS.ORG, by VA FILEMAN 22.2V0)",!
...
EN	; ENTER HERE TO BYPASS THE PRE-INIT PROGRAM
	...
	S DIFROM="22.2V1" D PKG:'$D(DIFROM(0)),^DIINIT1 G Q:'$D(DIFQ) S DIK(0)="AB"
